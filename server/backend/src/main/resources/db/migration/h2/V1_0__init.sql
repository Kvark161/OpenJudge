...
(name, DESCRIPTION, COMPILER_PATH, IS_COMPILED, INTERPRETER_PATH, EXTENSION, BINARY_EXTENSION, COMPILE_COMMAND, RUN_COMMAND)
VALUES
  ('g++17', 'C++ 17', 'g++', TRUE, NULL, 'cpp', 'exe', '{COMPILER_PATH} {SOURCE_CODE} -o {OUTPUT_EXE}',
   '{SOLUTION_EXE}'),
