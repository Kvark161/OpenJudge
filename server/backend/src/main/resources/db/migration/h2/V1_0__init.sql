...
(
  CONTEST_ID  BIGINT UNIQUE NOT NULL,
  DATA        CLOB          NOT NULL,
  LAST_UPDATE TIMESTAMP,
  CONSTRAINT DASHBOARD_CONTESTS_ID_FK FOREIGN KEY (CONTEST_ID) REFERENCES CONTESTS (ID)
);
...
VALUES
  ('g++17', 'C++ 17', 'g++', TRUE, NULL, 'cpp', 'exe',
            '{COMPILER_PATH} {SOURCE_CODE} -I {TESTLIB_FILE} -o {OUTPUT_EXE}',
